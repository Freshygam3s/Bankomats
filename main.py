...
numb_1 = tk.Button(button_frame, text="1",size="15")
numb_1.pack(side="left")
numb_2 = tk.Button(button_frame, text="2",size="15")
numb_2.pack(side="left")
numb_3 = tk.Button(button_frame, text="3",size="15")
numb_3.pack(side="left")

numb_4 = tk.Button(button_frame_1, text="4",size="15")
numb_4.pack(side="left")
numb_5 = tk.Button(button_frame_1, text="5",size="15")
numb_5.pack(side="left")
numb_6 = tk.Button(button_frame_1, text="6",size="15")
numb_6.pack(side="left")

numb_7 = tk.Button(button_frame_2, text="7",size="15")
numb_7.pack(side="left")
numb_8 = tk.Button(button_frame_2, text="8",size="15")
numb_8.pack(side="left")
numb_9 = tk.Button(button_frame_2, text="9",size="15")
numb_9.pack(side="left")

delete = tk.Button(button_frame_3, text="DEL",size="15")
delete.pack(side="left")
numb_0 = tk.Button(button_frame_3, text="0",size="15")
numb_0.pack(side="left")
Enter = tk.Button(button_frame_3, text="Enter",size="15", command= enter_func)
